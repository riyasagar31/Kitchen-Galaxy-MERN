                  ...
                  <tr key={item._id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        <img
                          src={`http://localhost:5000${item.image || (item.images && item.images[0])}`}
                          alt={item.name}
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border rounded-xl p-6 shadow-sm sticky top-24">
            ...
            <button
              ...
              className="w-full bg-[#ff5252] text-white py-4 rounded-xl font-bold hover:bg-red-600 transition-all shadow-lg shadow-orange-100 uppercase tracking-wide"
            >
              Proceed to Checkout
            </button>
